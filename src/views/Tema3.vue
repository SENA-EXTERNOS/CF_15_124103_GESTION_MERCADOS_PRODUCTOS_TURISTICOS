...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center
      .col-lg-2
            figure
              img(src='@/assets/curso/temas/tema3/img1.png' width='190px' height='104px').imagen-deco
      .col-lg-8.mt-4
          p Según París (2019), la comunicación visual puede servir para hipnotizar, atraer y convencer a un cliente. Y para lograrlo, se vale de imágenes, colores, fotos, gráficos y todo tipo de elementos visuales. Sin estos elementos, la publicidad, el diseño y el 
            i marketing 
            | pierden todo su potencial. La comunicación visual ayuda a fortalecer la forma en que la marca se comunica con los clientes.
    ...
    row
      .col-lg-12.mt-4
        figure
        .video
          iframe(width="560" height="315" src="https://www.youtube.com/embed/fcYxJzaEzUg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    .row.justify-content-center.align-items-center
      .col-lg-3
          figure
            img(src='@/assets/curso/temas/tema3/img3.png' width='295px' height='141px').imagen-deco
      .col-lg-5.mt-4
          p En cuanto al mensaje comunicacional: el proceso de la comunicación es un intercambio de ideas y contenidos que comienza desde un emisor hasta un receptor, y que luego se convierte, como mínimo, en una comunicación bidireccional. 
    ...
    .row.justify-content-center.align-items-center.mt-3
      .col-lg-5
        p Por último, frente a la semiótica, Yalán Dongo (2019) expresa que la disciplina de la semiótica, que también se puede conocer como semiología o teoría de los signos, es el estudio de cómo se usan los signos para la creación y transmisión de sentidos y significados cuando existe una comunicación. Se trata de una teoría que ha tenido consecuencias importantes en áreas como las ciencias humanas y sociales porque ayuda a entender de manera profunda las interacciones que se establecen, así como también algunos elementos de los contextos donde se desarrolla la sociedad.
      .col-lg-4
        figure
